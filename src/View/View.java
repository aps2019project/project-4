...
public class View {
    ...
    public static void showValidateDeckMessage(String deckName) throws View.Exceptions.DeckNotAvailabilityException {
        if (!Account.getCurrentAccount().getCollection().getDecks().containsKey(deckName))
            throw new View.Exceptions.DeckNotAvailabilityException(deckName);
